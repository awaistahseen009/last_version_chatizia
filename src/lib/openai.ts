...
export const generateChatResponse = async (
  ...
  try {
    // Build system message with custom system prompt if provided
    ...
    if (!systemPrompt && personality) {
      const personalityMap: Record<string, string> = {
        ...
        'encouraging': 'You are supportive, motivating, and help build confidence.',
        'caring': 'You are empathetic, compassionate, and understanding.'
      };
