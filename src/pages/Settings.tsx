...
const Settings: React.FC = () => {
  ...
  const [settings, setSettings] = useState(() => {
    ...
    return {
      ...
      systemPrompt: config.systemPrompt || '', // Add system prompt
      // Voice
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Enter the system prompt that will guide your chatbot's behavior and responses..."
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      This prompt defines how your chatbot behaves and responds. It will be sent to the AI model before each conversation to set the context and personality.
                    </p>
                  </div>
                    ...
                    <>
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-3">
                          Voice options are managed by administrators. Contact support to request additional voices.
                        </p>
                      </div>
